...
const restaurant_create_controller = require('../../controllers/restaurants/restaurant_create_controller');
...
//POST | CREATE USERS
router.post('/create_restaurants', restaurant_create_controller);
//DELETE | DELETE USERS
